...
""" script that starts Flask web application:
    ...
    Routes: 1- /: display “Hello HBNB!”
            ...
            7- /number_odd_or_even/<n>: display a HTML page only if n is an
                integer: H1 tag: “Number: n is even|odd” inside tag BODY
...
def number_int(n):
    """  number_int method: display “n is a number” only if n is integer """
    return ('{:d} is a number'.format(n))


@app.route('/number_template/<int:n>', strict_slashes=False)
def num_template(n):
    """ num_template method: display a HTML page only if n is integer
