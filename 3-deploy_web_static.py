#!/usr/bin/python3
""" Fabric script (based on file 2-do_deploy_web_static.py) that creates
and distributes archive to your web servers, using function deploy: """
...
# Call do_pack() function & store the path of created archive
# Return False if no archive has been created
# Call do_deploy(archive_path) func, using path of new archive
# Return return value of do_deploy
